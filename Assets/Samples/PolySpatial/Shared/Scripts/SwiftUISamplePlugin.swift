...
public typealias SetInjectViewDelegateType = (Bool) -> Void
public typealias SetPosDelegateType = (Float, Float, Float) -> Void

var callbackDelegate: CallbackDelegateType? = nil
var setInjectViewDelegate: SetInjectViewDelegateType? = nil
var setPosDelegate: SetPosDelegateType? = nil
...
@_cdecl("UpdateInjectView")
func updateInjectView(show: Bool){
    setInjectViewDelegate?(show)
}

public func SubscribeToUpdateInjectView(method: @escaping SetInjectViewDelegateType) {
    setInjectViewDelegate = method
}


@_cdecl("UpdateInjectViewPos")
func updateInjectViewPos(x: Float, y: Float, z: Float){
    setPosDelegate?(x, y, z)
}

public func SubscribeUpdatePos(method: @escaping SetPosDelegateType) {
    setPosDelegate = method
}
